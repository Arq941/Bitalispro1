...
function PersistentShell({children,initialTitle}:{children:ReactNode;initialTitle?:string}){
 ...
 useEffect(()=>{
  ...
  const onChanged=()=>refreshPermissions();
...
function BootShell(){return <div className="bitalis-app-shell min-h-[100dvh]"><header className="h-16 border-b border-[var(--bitalis-border)] bg-white/96"/><AppLoading/></div>}
