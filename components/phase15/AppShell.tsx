...
const admin=[{href:'/dashboard',label:'Inicio',icon:Home},{href:'/control-center',label:'Control',icon:Boxes},{href:'/cash',label:'Caja',icon:ReceiptText},{href:'/inventory',label:'Stock',icon:ClipboardCheck},{href:'/settings',label:'Más',icon:Settings}];
