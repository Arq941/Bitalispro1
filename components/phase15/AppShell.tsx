...
const routeTitles:[string,string][]=[['/settings/users','Usuarios'],['/settings/password-links','Enlaces de contraseña'],['/settings','Configuración'],['/admin-menu','Menú administrador'],['/supervision/down-payments','Enganches'],['/clients/new','Alta rápida'],['/clients','Clientes'],['/sales/new','Nueva venta'],['/sales','Ventas'],['/products','Productos'],['/portfolio','Cartera'],['/collections','Cobranza'],['/route','Ruta'],['/cash','Caja'],['/orders','Órdenes de compra'],['/inventory/catalogs','Proveedores y almacenes'],['/inventory/operations','Operaciones de inventario'],['/inventory','Stock'],['/renewals','Renovaciones'],['/commissions','Comisiones'],['/reports','Reportes'],['/audit','Auditoría'],['/authorizations','Autorizaciones'],['/control-center','Control'],['/notifications','Notificaciones'],['/dashboard','Inicio']];
